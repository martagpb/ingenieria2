...
public class PersonalHome {
	...
	public Personal merge(Personal detachedInstance) {
		...
		try {
			Personal result = (Personal) sessionFactory.getCurrentSession()
	...
	public Personal findById(java.lang.String id) {
		...
		try {
			Personal instance = (Personal) sessionFactory.getCurrentSession()
					.get("dominio.dominio.Personal", id);
			if (instance == null) {
	...
	public List findByExample(Personal instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"dominio.dominio.Personal").add(Example.create(instance))
					.list();
