...
*/
public class JPGestion_Bajas extends JPanel {
	...
	private void initialize() {
		cuenta = new JLabel();
		cuenta.setBounds(new Rectangle(121, 387, 70, 16));
	...
	private JTextField getNombre() {
		if (nombre == null) {
			...
			nombre.setBounds(new Rectangle(237, 142, 315, 20));
	...
	private JTextField getApellido1() {
		if (apellido1 == null) {
			...
			apellido1.setBounds(new Rectangle(236, 175, 317, 20));
	...
	private JTextField getApellido2() {
		if (apellido2 == null) {
			...
			apellido2.setBounds(new Rectangle(236, 205, 319, 20));
	...
	private JTextField getDireccion() {
		if (direccion == null) {
			...
			direccion.setBounds(new Rectangle(235, 277, 321, 20));
	...
	private JTextField getTelefono() {
		if (telefono == null) {
			...
			telefono.setBounds(new Rectangle(237, 347, 180, 20));
	...
	private JTextField getPoblacion() {
		if (poblacion == null) {
			...
			poblacion.setBounds(new Rectangle(237, 315, 251, 20));
	...
	private JTextField getCodigo() {
		if (codigo == null) {
			...
			codigo.setBounds(new Rectangle(237, 460, 108, 20));
	...
	private JTextField getDni() {
		if (dni == null) {
			dni = new JTextField();
			dni.setBounds(new Rectangle(236, 244, 143, 20));
	...
	private JTextField getTipo_cliente() {
		if (tipo_cliente == null) {
			...
			tipo_cliente.setBounds(new Rectangle(236, 425, 157, 20));
	...
	private JButton getAceptar() {
		if (aceptar == null) {
			aceptar = new JButton();
			aceptar.setBounds(new Rectangle(323, 513, 105, 30));
	...
	private JTextField getNº_cuenta() {
		if (nº_cuenta == null) {
			...
			nº_cuenta.setBounds(new Rectangle(235, 387, 334, 20));
